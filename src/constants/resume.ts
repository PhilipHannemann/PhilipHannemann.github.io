...
export const EDUCATION: ReadonlyArray<ResumeEntry> = [
  ...
  },
  {
    ...
    subheadline:
      "Thesis: Streckendaten-basierte Optimal-Steuerung von Hybridzügen in Echtzeitumgebungen",
    time: "2017 - 2020",
  ...
  },
  {
    ...
    subheadline:
      "Thesis: Verbesserung eines Aufmerksamkeitsmodells mit Deep Learning und Data Augmentation",
    time: "2014 - 2018",
    at: "TU Chemnitz",
...
export const CARRIER: ReadonlyArray<ResumeEntry> = [
  {
    ...
    at: "STTech",
    description:
      "After 1,5 years at STTech, serving as the Head of Process Automation, my focus is to revolutionize the claim handling processes for insurance companies, particularly within the domain of dentist invoices. This domain allowed me to leverage automation to enhance efficiency, accuracy, and customer satisfaction.",
    workingOn: [],
  },
  {
