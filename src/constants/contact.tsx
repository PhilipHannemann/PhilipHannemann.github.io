...
export const CONTACT_DATA: ListElement[] = [
  ...
  [Linkedin, "LinkedIn:", <Link href="www.linkedin.com/in/philiphannemann">linkedin.com/in/philiphannemann</Link>],
  [Github, "Git:", <Link href="https://github.com/PhilipHannemann">github.com/PhilipHannemann</Link>],
