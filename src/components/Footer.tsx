...
export default function Footer({ extented }: FooterProps) {
  ...
  const description = extented && (
    <p>
      This webside does not have the need for Next.js and React because there is
      not much interaction with its content and no server functionality is
      needed.
      <br />
      But to show, that I&apos;m good at developing I have made the entire
